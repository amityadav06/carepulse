...
interface CustomProps {
    control: Control<any>  // Control type coming from react-hook-form
    fieldType: FormFieldType // enum we defined in other file
    name: string
    label?: string
    placeholder?: string
    iconSrc?: string
...
const RenderField = ({ field, props } : { field: any, props: CustomProps }) => {
    ...
    switch (fieldType) {
        ...
        case FormFieldType.SKELETON:
            return(
                renderSkeleton ? renderSkeleton(field) : false
            )
